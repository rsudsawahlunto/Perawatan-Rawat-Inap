...
Begin VB.Form frmOrderPelayanan 
   ...
   Begin VB.Image Image1 
      Height          =   975
      Left            =   0
      Picture         =   "frmOrderPelayanan.frx":238E
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image2 
      Height          =   945
      Left            =   11400
      Picture         =   "frmOrderPelayanan.frx":4D4F
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
...
lanjut_:
            ...
            Case 1
                ...
                For i = 1 To fgData.Rows - 1
                    If fgData.TextMatrix(i, 4) = 0 Then MsgBox "Cek Jumlah Barang ", vbExclamation, "Validasi": fgData.SetFocus: fgData.Col = 4: Exit Sub
                Next i
        ...
        Case 3 ' nama barang
           ...
           If dcRuanganTujuan.Text = "" Then
            ...
            With dgObatAlkes
                ...
                .Top = 3720 '1680 'txtIsi.Top + txtIsi.Height '+ Frame8.Top
                .Left = 2400 '3360
                .Visible = True
...
On Error GoTo errLoad
    ...
    With dbcmd
        ...
        .Parameters.Append .CreateParameter("KdWaktuEtiket2", adChar, adParamInput, 2, IIf(f_KdWaktuEtiket2 = "", Null, f_KdWaktuEtiket2))
...
'        .Parameters.Append .CreateParameter("NoPakai", adChar, adParamInput, 10, Null)
        .Parameters.Append .CreateParameter("NoPakai", adChar, adParamInput, 10, IIf(Trim(txtNoPakai.Text) = "", Null, Trim(txtNoPakai.Text)))
        .Parameters.Append .CreateParameter("NoRetur", adChar, adParamInput, 10, Null)
