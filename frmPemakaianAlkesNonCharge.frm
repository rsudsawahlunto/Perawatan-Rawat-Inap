...
Begin VB.Form frmPemakaianAlkesNonCharge 
   ...
   Caption         =   "Medifirst2000 - Pemakaian Bahan"
   ClientHeight    =   6750
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10965
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   9120
      Picture         =   "frmPemakaianAlkesNonCharge.frx":368B
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
...
Private Sub cmdTambah_Click()
    ...
    With fgAlkes
        ...
        With fgAlkes
            ...
            '        .TextMatrix(.Rows - 1, 5) = txthargasatuan.Text
...
Private Sub dcJnsPelayanan_GotFocus()
    ...
    strSQL = "select distinct kdjnspelayanan, JenisPemeriksaan from V_RiwayatPemeriksaanPasien where NoPendaftaran = '" & txtNoPendaftaran.Text & "' AND KdRuangan = '" & mstrKdRuangan & "'"
...
Private Sub dcPelayanan_GotFocus()
    ...
    strSQL = "select distinct kdpelayananrs,NamaPemeriksaan from V_RiwayatPemeriksaanPasien where kdjnspelayanan = '" & dcJnsPelayanan.BoundText & "' AND NoPendaftaran = '" & txtNoPendaftaran.Text & "' AND KdRuangan = '" & mstrKdRuangan & "'"
...
Private Sub dcPelayanan_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then dcTglPelayanan.SetFocus
End Sub

Private Sub dcTglPelayanan_Change()
    On Error GoTo errLoad
    Dim i As Integer
...
Private Sub dcTglPelayanan_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then txtNamaBrg.SetFocus
End Sub
...
Private Sub txtNamaBrg_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyEscape Then fraObatAlkes.Visible = False
End Sub
...
Private Function sp_PemakaianAlkesNonCharge(f_KdPelayananRS As String, _
    ...
    With dbcmd
        ...
        If .Parameters("return_value").Value <> 0 Then
            MsgBox "Ada kesalahan dalam penyimpanan data", vbCritical, "Vlidasi"
