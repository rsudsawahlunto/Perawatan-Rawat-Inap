...
Private Sub dcGroup_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        ...
        If optPabrik.Value = True Then
            strSQL = "SELECT KdPabrik, NamaPabrik FROM Pabrik WHERE (NamaPabrik LIKE '%" & dcGroup.Text & "%') and StatusEnabled='1'"
        ElseIf optAsalBarang.Value = True Then
            strSQL = "SELECT KdAsal, NamaAsal FROM AsalBarang WHERE NamaAsal LIKE '%" & dcGroup.Text & "%') and StatusEnabled='1'"
        ElseIf optJenisBarang.Value = True Then
            strSQL = "SELECT KdJenisBarang, JenisBarang FROM JenisBarang WHERE JenisBarang LIKE '%" & dcGroup.Text & "%') and StatusEnabled='1'"
        ElseIf optStatusBarang.Value = True Then
            strSQL = "SELECT KdStatusBarang, StatusBarang FROM StatusBarang WHERE StatusBarang LIKE '%" & dcGroup.Text & "%') and StatusEnabled='1'"
        ElseIf optGolonganBarang.Value = True Then
            strSQL = "SELECT KdGolBarang, GolonganBarang FROM GolonganBarang WHERE GolonganBarang LIKE '%" & dcGroup.Text & "%') and StatusEnabled='1'"
        Else
            optPabrik.SetFocus
        End If
