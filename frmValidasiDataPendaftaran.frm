...
Begin VB.Form frmValidasiDataPendaftaran 
   ...
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmValidasiDataPendaftaran.frx":4BA1
      Stretch         =   -1  'True
      Top             =   0
      Width           =   12135
   End
...
'                " FROM V_DaftarPasienRI4Validasi Where (StatusKeluar = '" & cbKeluar & "'  AND StatusPulang ='" & cbPulang & "' ) AND RuanganPelayanan = '" & mstrNamaRuangan & "' "
...
'
'
'Private Sub cbKeluar_Click()
''    Call optRI_Click
'End Sub
'
'Private Sub cbPulang_Click()
''    Call optRI_Click
'End Sub
'
'
