...
'            MsgBox "Data tersebut sudah diinput, check lagi", vbInformation, "" & objGridArrayName(i, intColArray)
            objGridName.ReBind
            objGridName.SetFocus
'            objGridName.Col = intColArray
            objGridName.Row = i
            Exit Function
        End If
    Next
...
Public Sub SetKeyPressToCharToNumber(KeyAscii As Integer)
    ...
    If Not ((KeyAscii >= 48 And KeyAscii <= 57) Or (KeyAscii < 48 Or KeyAscii > 57) Or (KeyAscii <> 46)) Then KeyAscii = 0
