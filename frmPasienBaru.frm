...
Public Sub subLoadDataPasien(strInput As String)
    ...
    Dim strSQLLoadDetailPasien As String '#
    Dim rsLoadDetailPasien As New ADODB.recordset '#
    ...
    strSQLLoadDetailPasien = "SELECT * FROM DetailPasien WHERE NoCM = '" & strInput & "'"
    Set rsLoadDetailPasien = Nothing
    rsLoadDetailPasien.Open strSQLLoadDetailPasien, dbConn, adOpenForwardOnly, adLockReadOnly
    If rsLoadDetailPasien.EOF = True Then Exit Sub
...
'    dtpTglPendaftaran.value = rsLoadPasien.Fields("TglDaftarMembership").value
    ...
    If Not IsNull(rsLoadDetailPasien.Fields("NoKK").Value) Then txtNoKK.Text = rsLoadDetailPasien.Fields("NoKK").Value
    If Not IsNull(rsLoadDetailPasien.Fields("NamaKepalaKeluarga").Value) Then txtKepalaKeluarga.Text = rsLoadDetailPasien.Fields("NamaKepalaKeluarga").Value
    If Not IsNull(rsLoadDetailPasien.Fields("NamaIbu").Value) Then txtIbuKandung.Text = rsLoadDetailPasien.Fields("NamaIbu").Value
