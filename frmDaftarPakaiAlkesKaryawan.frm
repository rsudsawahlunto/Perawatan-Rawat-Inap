...
Private Sub cmdCari_Click()
    ...
    strsqlku = "select * from V_PemakaianBahanNObatx where KdRuangan='" & mstrKdRuangan & "' and Tanggal BETWEEN '" & Format(dtpAwal.Value, "yyyy-MM-dd 00:00:00") & "' AND '" & Format(dtpAkhir.Value, "yyyy-MM-dd 23:59:59") & "'"
