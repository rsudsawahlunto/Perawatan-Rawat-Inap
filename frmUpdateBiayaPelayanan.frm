...
Public Sub txtNoPendaftaran_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = 13 Then
        ...
        " WHERE NoPendaftaran = '" & txtNoPendaftaran.Text & "' AND (KdPelayananRS = '" & strKodePelayananRS & "')AND (TglPelayanan = '" & Format(frmTransaksiPasien.dgTindakan.Columns(0), "yyyy/MM/dd HH:mm:ss") & "') AND (KdRuangan = '" & frmTransaksiPasien.dgTindakan.Columns(13) & "')"
        Call msubRecFO(rs, strSQL)

        If rs.RecordCount = 0 Then

            MsgBox "Data ini bermasalah saat penyimpanan, tolong dihapus dan diinput ulang", vbExclamation, "Validasi"
        Else
            ...
            txtKdRuangan.Text = Trim(frmTransaksiPasien.dgTindakan.Columns(13))
