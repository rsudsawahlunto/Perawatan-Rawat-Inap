...
Begin VB.Form frmLaporanPendapatanRuangan 
   ...
   EndProperty
   Icon            =   "frmLaporanPendapatanRuangan.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmLaporanPendapatanRuangan.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image2 
      Height          =   945
      Left            =   6960
      Picture         =   "frmLaporanPendapatanRuangan.frx":368B
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmLaporanPendapatanRuangan.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9495
   End
