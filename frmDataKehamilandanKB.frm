...
Private Sub subSimpanKehamilan()
    ...
    'If txtBulanKehamilan.Text <= 0 Then
...
Private Sub dcImunisasi_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        ...
        If rs.EOF = True Then
            dcImunisasi.Text = ""
            txtKeteranganKehamilan.SetFocus
            Exit Sub
        End If
...
Private Sub txtBulanKehamilan_LostFocus()
    ...
    If Val(txtBulanKehamilan.Text) > 9 Then txtBulanKehamilan.Text = "9"
End Sub
...
Private Sub txtHariKehamilan_Change()
    Dim dTglLahir As Date
    If Len(txtHariKehamilan.Text) > 2 Then
        MsgBox "Hari Hanya 2 Digit ", vbOKOnly + vbInformation, "Validasi"
        txtHariKehamilan.Text = 0
    Else
