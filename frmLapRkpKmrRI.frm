...
Begin VB.Form frmLapRkpKmrRI 
   ...
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmLapRkpKmrRI.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmLapRkpKmrRI.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9495
   End
...
stepDokter:
            ...
            ElseIf rsTemp2("Ruangan").Value <> rs("Ruangan").Value Then
                ...
                .TextMatrix(iRowNow, 2) = .TextMatrix(iRowNow - 1, 2)
                .TextMatrix(iRowNow, 3) = "Sub Total"
                .TextMatrix(iRowNow, 4) = rsTemp2("JmlBedTerisi").Value
                .TextMatrix(iRowNow, 5) = rsTemp2("JmlBedKosong").Value
                .TextMatrix(iRowNow, 6) = rsTemp2("TTotalBed").Value
                subSetSubTotalRow iRowNow, 3, vbBlackness, vbWhite
                rsTemp2.MoveNext
            End If
