...
Private Sub subLoadGridSource()
    ...
    With dgDiagnosaKeperawatan
        ...
        .Columns(2).Caption = "Kode Diagnosa"
...
Private Sub txtKdDiagnosa_Change()
    ...
    strFilterDiagnosa = "WHERE KdDiagnosa like '%" & txtKdDiagnosa.Text & "%' or NamaDiagnosa like '%" & txtKdDiagnosa.Text & "%'"
...
Private Function sp_DiagnosaKeperawatan(f_Status As String) As Boolean
    ...
    With dbcmd
        ...
        .Parameters.Append .CreateParameter("KdDiagnosa", adVarChar, adParamInput, 7, txtKdDiagnosa.Text)
