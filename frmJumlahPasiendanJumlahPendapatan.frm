...
Dim sQuery As String
    ...
    pbData.Max = fgData.Rows - 3
        ...
        sQuery = "Insert into V_LapRITemp" & _
                " values (" & _
                " " & sValuesMoney & "" & _
                " " & sValues & "" & _
                " )"
...
Private Sub cmdCetak_Click()
    ...
    If xError = "" Then
       ...
       Call getdatarekap
       Call IsiTabelTemp
       strSQL = "select * from V_LapRITemp Where NamaKomputer='" & strNamaHostLocal & "'"
...
'    sQuery = "drop Table V_LapLabNo2_NewTemp" & "_" & strNamaHostLocal & ""
    sQuery = "delete V_LapRITemp Where NamaKomputer= '" & strNamaHostLocal & "'"
    dbConn.Execute sQuery
End Sub
