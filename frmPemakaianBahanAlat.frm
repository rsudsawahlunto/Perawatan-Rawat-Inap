...
Private Sub dgObatAlkes_DblClick()
    ...
    fgAlkes.TextMatrix(fgAlkes.Row, 1) = dgObatAlkes.Columns("Nama Barang")
    fgAlkes.TextMatrix(fgAlkes.Row, 2) = dgObatAlkes.Columns("AsalBarang")
    fgAlkes.TextMatrix(fgAlkes.Row, 3) = dgObatAlkes.Columns("SatuanJml")
    ...
    strSQL = ""
    Set rsB = Nothing
    strSQL = "SELECT dbo.FB_TakeHargaNettoOA('2222222222','01','" & dgObatAlkes.Columns("KdBarang") & "','" & dgObatAlkes.Columns("KdAsal") & "','" & dgObatAlkes.Columns("SatuanJml") & "', '" & mstrKdRuangan & "','" & strNoTerima & "') AS HargaBarang"
...
'    Call msubRecFO(rsb, strSQL)
    Call msubRecFO(rsB, "select dbo.FB_TakeStokBrgMedis('" & mstrKdRuangan & "', '" & dgObatAlkes.Columns("KdBarang") & "','" & dgObatAlkes.Columns("KdAsal") & "') as stok")
    ...
    Select Case fgAlkes.Col
        ...
        Case 1 ' nama barang
            ...
            With dgObatAlkes
                ...
                .Columns("SatuanJml").Width = 675
'                .Columns("HargaBarang").Width = 1000
...
'                            End If
                        End If
                    End If
'                    If .TextMatrix(.Row, 6) = "" Then .TextMatrix(.Row, 6) = 0
...
Private Sub subLoadDcSource()
   ...
   strSQL = "select  distinct kdpelayananrs,namapelayanan from V_ListPemakaianBahanx "
