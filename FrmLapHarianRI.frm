...
Begin VB.Form FrmLapHarianRI 
   ...
   End
End
Attribute VB_Name = "FrmLapHarianRI"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New LapHarianRI
...
Dim laporan As New ADODB.Command
     ...
     With laporan
        .ActiveConnection = dbConn
         .CommandText = "SELECT * " _
                       & "FROM V_RegisterPasienRI where kdruangan='" & strNKdRuangan & "' and dbo.ubahtanggal(TglPendaftaran) BETWEEN '" & Format(frmtgllap.DTPickerAwal, "yyyy/mm/dd") & "' AND '" & Format(frmtgllap.DTPickerAkhir, "yyyy/mm/dd") & "'"
  ...
  End If
     ...
     With Report
        ...
        .txttgl.SetText tgl
        .UnboundString1.SetUnboundFieldSource ("{ado.TglPendaftaran}")
...
'        .UnboundString12.SetUnboundFieldSource ("{ado.Penjamin}")
        .UnboundString13.SetUnboundFieldSource ("{Ado.namaruangan}")
        .UnboundString14.SetUnboundFieldSource ("{ado.namaSubInstalasi}")
