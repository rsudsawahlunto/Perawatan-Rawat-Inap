...
'2008-02-25 restrict changes on old patients JEP
...
Public strSQLa1 As String
Public strSQLX As String
Public strSQLy As String
Public strSQLz As String
Public strSQLa As String
Public strSQLb As String
Public strSQLb1 As String
Public strSQLc1 As String
Public strSQLc As String
Public strSQLd As String
Public strSQLe As String
Public strSQLf As String
Public strSQLg As String
Public strSQLh As String
Public strSQLi As String
Public strSQLj As String
Public strSQLk As String
Public strSQLl As String
Public strSQLm As String
Public strSQLd1 As String
Public strsqll1 As String
Public strsqle1 As String
Public strsqlf1 As String
Public strSQLi1 As String
Public strSQLg1 As String
Public strSQLh1 As String
Public strSQLk1 As String
Public strSQLj1 As String
Public strSQLm1 As String
...
Public rsz As New ADODB.recordset
Public rsb1 As New ADODB.recordset
Public rsl1 As New ADODB.recordset
Public rsd1 As New ADODB.recordset
Public rsf1 As New ADODB.recordset
Public rsg1 As New ADODB.recordset
Public rsi1 As New ADODB.recordset
Public rsh1 As New ADODB.recordset
Public rsk1 As New ADODB.recordset
Public rsj1 As New ADODB.recordset
Public rsm1 As New ADODB.recordset
...
''add splakuk for Indikator need 2010/10/27 @semarang
