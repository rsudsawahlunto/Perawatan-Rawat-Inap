...
Private Sub cmdCari_Click()
    ...
    With fgData
        ...
        While rs.EOF = False
            ...
            .TextMatrix(iRowNow, 14) = rs("Kel_H").Value
            .TextMatrix(iRowNow, 15) = rs("Kel_M").Value
            rs.MoveNext
        Wend
    End With
    fgData.Visible = True
...
Private Sub subSetGrid()
    With fgData
        ...
        .TextMatrix(0, 14) = "KeluarHidup"
        .TextMatrix(0, 15) = "KeluarMati"
