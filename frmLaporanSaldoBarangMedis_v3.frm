...
'Rombak Pada Bagian Private Sub cmdProses_Click() by Bangkit Gelo (20130926)
'Aing Ge Lieur Nyieunna, cek we sorangan (Bikinnya dalam Kondisi Otak Kurang Waras )
...
Private Sub cmdProses_Click()
    ...
    If bolStatusFIFO = True Then
        Set rs = Nothing
        strSQL = " Select *   From V_StokBarangMedisRuanganLengkapFIFO Where KdRuangan='" & mstrKdRuangan & "'" & sFltrAsalBrg & sFltrGroupBy
