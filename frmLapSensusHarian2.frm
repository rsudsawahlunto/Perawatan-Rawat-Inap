...
Begin VB.Form frmLapSensusHarian2 
   ...
   EndProperty
   Icon            =   "frmLapSensusHarian2.frx":0000
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ScaleHeight     =   3510
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   3360
      Picture         =   "frmLapSensusHarian2.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1275
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmLapSensusHarian2.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmLapSensusHarian2.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   2775
   End
End
Attribute VB_Name = "frmLapSensusHarian2"
...
Private Sub cmdCetak_Click()
    ...
    strSQL = " select * from V_DaftarPasienRIAktif" & _
    " where Ruangan='" & strNNamaRuangan & "' "

    Call msubRecFO(rs, strSQL)
    If rs.EOF = True Then MsgBox "Tidak Ada Data", vbExclamation, "Validasi": Exit Sub
    frmCetakSensusHarian2.Show
